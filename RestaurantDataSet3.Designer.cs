...
namespace Final_Resturant {
    ...
    public partial class RestaurantDataSet3 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Emp_ID, string Emp_Name, string Address, string Contact_No, string Gender, string Designation, string email) {
...
namespace Final_Resturant.RestaurantDataSet3TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([Emp_ID] = @Original_Emp_ID) AND ([Emp_Name] = @Original_Emp_Name) AND ([Address] = @Original_Address) AND ([Contact_No] = @Original_Contact_No) AND ([Gender] = @Original_Gender) AND ([Designation] = @Original_Designation) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Emp_ID], [Emp_Name], [Address], [Contact_No], [Gender], [Designation], [email]) VALUES (@Emp_ID, @Emp_Name, @Address, @Contact_No, @Gender, @Designation, @email);
SELECT Emp_ID, Emp_Name, Address, Contact_No, Gender, Designation, email FROM Employee WHERE (Emp_ID = @Emp_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Emp_ID] = @Emp_ID, [Emp_Name] = @Emp_Name, [Address] = @Address, [Contact_No] = @Contact_No, [Gender] = @Gender, [Designation] = @Designation, [email] = @email WHERE (([Emp_ID] = @Original_Emp_ID) AND ([Emp_Name] = @Original_Emp_Name) AND ([Address] = @Original_Address) AND ([Contact_No] = @Original_Contact_No) AND ([Gender] = @Original_Gender) AND ([Designation] = @Original_Designation) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT Emp_ID, Emp_Name, Address, Contact_No, Gender, Designation, email FROM Employee WHERE (Emp_ID = @Emp_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Emp_ID, Emp_Name, Address, Contact_No, Gender, Designation, email FROM dbo" +
                ".Employee";
        ...
        public virtual int Fill(RestaurantDataSet3.EmployeeDataTable dataTable) {
        ...
        public virtual RestaurantDataSet3.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RestaurantDataSet3.EmployeeDataTable dataTable = new RestaurantDataSet3.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RestaurantDataSet3.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Emp_ID, string Original_Emp_Name, string Original_Address, string Original_Contact_No, string Original_Gender, string Original_Designation, string Original_email) {
        ...
        public virtual int Insert(string Emp_ID, string Emp_Name, string Address, string Contact_No, string Gender, string Designation, string email) {
            if ((Emp_ID == null)) {
        ...
        public virtual int Update(string Emp_ID, string Emp_Name, string Address, string Contact_No, string Gender, string Designation, string email, string Original_Emp_ID, string Original_Emp_Name, string Original_Address, string Original_Contact_No, string Original_Gender, string Original_Designation, string Original_email) {
            if ((Emp_ID == null)) {
                throw new global::System.ArgumentNullException("Emp_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Emp_Name, string Address, string Contact_No, string Gender, string Designation, string email, string Original_Emp_ID, string Original_Emp_Name, string Original_Address, string Original_Contact_No, string Original_Gender, string Original_Designation, string Original_email) {
            return this.Update(Original_Emp_ID, Emp_Name, Address, Contact_No, Gender, Designation, email, Original_Emp_ID, Original_Emp_Name, Original_Address, Original_Contact_No, Original_Gender, Original_Designation, Original_email);
        }
    }
